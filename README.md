...
This is an RC plane build for Fallout Event of Hackclub. This plane is my first plane to be made to enter in the aerospace. This plane is for training purpose since my next project is to make a ground control station.
...
| Length | 58 cm|
| Weight |  |
| Airframe Material | Sunboard/Depron Sheet |
| Motor | A2212 1400 Kv |
| ESC | SimonK 30A |
